...
*/
		...
		//ZONE DE TEST
		Enchere en3 = new Enchere(03,"Ancienne bomb nuclaire","American", 40, EtatEnchere.EN_ATTENTE,"Collection");
        Enchere en4 = new Enchere(04,"Ancienne nuclaire bomb","Russian",60,EtatEnchere.EN_ATTENTE,"Collection");
		//Stock sto = new Stock();
		Agent agent1 = new Agent(01,8000);
		...
		//agent1.comparerPrixAchat(en3,agent1);
		System.out.println(" ");
